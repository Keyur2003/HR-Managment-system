...
if(isset($_POST['submit'])){
        ...
        $query1 = "UPDATE userprofile SET username='$username',firstname='$firstname',m_name='$m_name',lastname='$lastname',join_date='$join_date' where uid=$update";
        $query2 = "UPDATE credentials SET username='$username',password='$password' where id='$user_code'";
        $query3 = "UPDATE bank_details SET bank_name='$bank_name',account_number='$account_number',pan_no='$pan_no',pf_no='$pf_no' where emp_id='$update'";
